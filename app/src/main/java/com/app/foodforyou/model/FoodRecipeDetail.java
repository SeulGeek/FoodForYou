...
public class FoodRecipeDetail {
    ...
    private String chlsInfo; // 콜레스트롤 정보
    ...
    private String vtmaInfo; // 비타민A 정보
    private String vtmbInfo; // 비타민B 정보
    private String vtmcInfo; // 비타민C 정보
